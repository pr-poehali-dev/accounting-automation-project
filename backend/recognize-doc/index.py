...
1) ПЕРВЫМ ДЕЛОМ ищи строку «Итого», «ИТОГО», «Всего к оплате», «К оплате», «Итого с НДС», «Всего», «на сумму».
...
{"amount":30039.26,"date":"2025-01-23","category":"Закупка товара","comment":"Накладная — 52 позиции товара, итого 30 039 руб","doc_type":"Накладная","counterparty":"ИП Гришин Сергей Викторович","inn":null,"type":"expense"}"""
